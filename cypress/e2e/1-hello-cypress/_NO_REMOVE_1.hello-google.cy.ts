describe('Google Search', () => {
  beforeEach(() => {
    ...
    cy.intercept(`/data:image/jpeg;base64**`, { fixture: "image2_placeholder.png" });
    cy.intercept(`/data:image/jpeg**`, { fixture: "image2_placeholder.png" });
  ...
  it('should check if google site is active', () => {
  ...
  it.only('should check if google site is active', () => {
    cy
      .visit('https://www.google.com/search?q=Mario+Biondi')
      .get('button')
      .contains('accetta', { matchCase: false })
      .click()
